package com.sarahmizzi.fyp.kodi.jsonrpc.api.provider;
...
import com.sarahmizzi.fyp.utils.SelectionBuilder;
...
public class MediaProvider extends ContentProvider {
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        try {
            ...
            Log.d(TAG, "Couldn't bulk insert records. Exception: " + e.getMessage());
        } finally {
            db.endTransaction();
        }
        getContext().getContentResolver().notifyChange(uri, null);

        Log.d(TAG, "Bulk insert finished for uri (" + uri +
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        int result = builder.where(selection, selectionArgs)
                .delete(db);
        Log.d(TAG, "delete(uri=" + uri + "). Rows affected: " + result);
        getContext().getContentResolver().notifyChange(uri, null);
        return result;
    }
